...
THREEx.ProceduralCity = function() {
    ...
    //我自己注释的
    // geometry.faceVertexUvs[0][2][0] = new THREE.Vector2(0, 0);
    // geometry.faceVertexUvs[0][2][1] = new THREE.Vector2(0, 0);
    // geometry.faceVertexUvs[0][2][2] = new THREE.Vector2(0, 0);
    // geometry.faceVertexUvs[0][2][3] = new THREE.Vector2(0, 0);
    ...
    for (var i = 0; i < 200; i++) {
        ...
        buildingMesh.position.x = -Math.floor(Math.random() * 1000);
        buildingMesh.position.z = -Math.floor(Math.random() * 200 + 20);
